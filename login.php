...
<body class="demo">
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <table class="table table-borderless">
        <tr>
            <td>Username</td>
            <td><input id="uname" type="text" class="gorm-control"></td>
        </tr>
        <tr>
            <td>Password</td>
            <td><input id="pass" type="text" class="gorm-control"></td>
        </tr>
        <tr>
            <td></td>
            <td><Button onclick="myclickbutton()" class="btn btn-success">LOGIN</Button></td>
        </tr>
    </table>
    <script>
